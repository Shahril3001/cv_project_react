...
const ViewCV = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            const res1 = await axios.get(`http://127.0.0.1:5000/api/profile/${id}`);
            setPerson(res1.data);
            const res2 = await axios.get(`http://127.0.0.1:5000/api/work/${id}`);
            setWorks(res2.data);
            const res3 = await axios.get(`http://127.0.0.1:5000/api/education/${id}`);
            setEducations(res3.data);
            const res4 = await axios.get(`http://127.0.0.1:5000/api/skill/${id}`);
            setSkills(res4.data);
            const res5 = await axios.get(`http://127.0.0.1:5000/api/language/${id}`);
            setLanguages(res5.data);
            const res6 = await axios.get(`http://127.0.0.1:5000/api/hobby/${id}`);
